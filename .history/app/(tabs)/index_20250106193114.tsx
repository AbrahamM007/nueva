...
interface User {
  ...
  email: string;
  password: string;
  // userType?: string; // REMOVED userType altogether
}
...
const App: React.FC = (): React.ReactNode => {
  ...
  // If you need a valid YouTube Key, add it here:
  ...
  // No user type is enforced; we removed that entirely
  ...
  const renderAppsContent = () => {
    const appsData = [
      { label: "Ministry", icon: "rose-outline", onPress: () => {/* Navigate */} },
      { label: "Bible", icon: "book-outline", onPress: () => {/* Navigate */} },
      { label: "Events", icon: "calendar-outline", onPress: () => {/* Navigate */} },
      { label: "Music", icon: "musical-notes-outline", onPress: () => {/* Navigate */} },
      { label: "Preaching", icon: "megaphone-outline", onPress: () => {/* Navigate */} },
      { label: "Donation", icon: "wallet-outline", onPress: () => {/* Navigate */} },
      { label: "Chat", icon: "chatbubble-ellipses-outline", onPress: () => {/* Navigate */} },
      { label: "Life Groups", icon: "leaf-outline", onPress: () => {/* Navigate */} },
    ];
