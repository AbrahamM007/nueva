...
const App: React.FC = () => {
  ...
  const handleCreateService = () => {
    if (!serviceTitle.trim() || !serviceDate) { Alert.alert("Error", "Please enter service title and date."); return; }
    ...
    return (
      <View style={styles.appContainer}>
        <View style={styles.sectionHeaderRow}>
          ...
          <TouchableOpacity 
            style={[styles.addButton, {backgroundColor: "#2D6A4F"}]} 
  ...
  const renderServicesPage = () => {
    ...
    return (
      <View style={styles.appContainer}>
        {/* ... Services implementation remains as before ... */}
      </View>
    );
  };
  ...
  const renderProfileScreen = () => {
    ...
    return (
      <ScrollView contentContainerStyle={styles.homeScreenScroll}>
        {/* ... Profile implementation remains as before ... */}
      </ScrollView>
    );
  };
  ...
  const renderAuthScreen = () => {
    return (
      <View style={styles.authScreen}>
        {/* ... Auth screen implementation remains as before ... */}
      </View>
    );
  };
  ...
  const renderChatListPage = () => {
    ...
    return (
      <View style={styles.appContainer}>
        {/* ... Chat list implementation remains as before ... */}
      </View>
    );
  };
  ...
  const renderChatConversation = () => {
    ...
    // ... Chat conversation implementation remains as before ...
  };
      ...
      case "apps":
        return (() => {
          switch(appsSubScreen) {
            ...
            default: return renderAuthScreen();
          }
        })();
      case "profile":
      ...
      {currentScreen === "login" || currentScreen === "signup" ? (
        ...
        <SafeAreaView style={styles.appContainer}>
          ...
          <View style={styles.bottomNav}>
            {/* ... Bottom navigation remains as before ... */}
          </View>
        </SafeAreaView>
      )}
    </KeyboardAvoidingView>
