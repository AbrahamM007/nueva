...
type Screen = "login" | "signup" | "home" | "watch" | "apps" | "profile";
    ...
    <FlatList
      ...
      ListHeaderComponent={
        <>
          ...
          {renderVideoCard()}
          <Text style={[styles.sectionHeader, { marginTop: 16 }]}>Past Videos</Text>
        </>
      }
      data={pastVideos}
      ...
      renderItem={({ item }) => (
        <TouchableOpacity
          ...
          onPress={() => {
            // When a past video is tapped, play it in the video player
            setLatestVideoId(item.id.videoId);
          }}
        >
          <Image
